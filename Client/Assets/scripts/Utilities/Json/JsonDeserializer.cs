namespace Utilities.Json
{
    ...
    public class JsonDeserializer
    {
        ...
        private object DeserializeList(Type listType)
        {
			...
			if(_reader.AssertAndConsume(JsonTokens.StartArrayCharacter) == true)
				return null;
        ...
        {
			if(_reader.AssertAndConsume(JsonTokens.StartObjectLiteralCharacter) == true)
				return null;
